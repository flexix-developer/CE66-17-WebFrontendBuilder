...
const DesignPage = () => {
  ...
  const fetchPages = async () => {
    try {
      ...
      const response = await axios.get(
        `http://ce66-17.cloud.ce.kmitl.ac.th:8081/users/getpages/${ID}/${ProjectID}`,
  ...
  const handleCreateButtonClick = async (e) => {
    ...
    if (pagename === "") {
      ...
      try {
        await axios.post(
          "http://ce66-17.cloud.ce.kmitl.ac.th:8081/users/page",
  ...
  const handleEyeIconClick = async () => {
    ...
    try {
      const response = await axios.post(
        "http://ce66-17.cloud.ce.kmitl.ac.th:8081/users/gethtmlandscript",
